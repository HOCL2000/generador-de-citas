...
const Aside = () => {
  ...
  return (
  <aside className='absolute top-0 left-0 flex w-full bg-transparent  '>
  <div className='z-[9999]'>
  <Drawer.Root >
      <Drawer.Trigger className='z-0' asChild>
        <button className='z-0 b-zinc-200 p-2 m-1 border shadow rounded-full '> <Tools/> </button>
      </Drawer.Trigger>
      <Drawer.Portal>

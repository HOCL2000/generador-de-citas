...
import { allDaysData, allUsersData, changeState, crearAdmin, createNewDay, getDayByDate, iniciarSesion } from "../controllers/administracion.js";
...
router.get('/users', auth, allUsersData)
